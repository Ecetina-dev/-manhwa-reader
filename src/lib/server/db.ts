...
function ensureDB(): void {
  ...
  if (!existsSync(DB_FILE)) {
    writeFileSync(
      DB_FILE,
      JSON.stringify({ manga: {}, chapters: {}, pages: {} }, null, 2),
    );
  }
}
...
export function seedDatabase(): void {
  ...
  const popularManga = [
    ...
    },
    {
      title: "Tower of God",
      description:
        "Tower of God follows the story of Bam, a young man who enters the mysterious Tower to find his friend Rachel.",
    ...
    },
    {
      title: "Naruto",
      description:
        "Naruto Uzumaki, a young ninja with a demon fox sealed inside him, dreams of becoming the Hokage.",
    ...
    },
    {
      ...
      description:
        "In a world where humanity lives within cities surrounded by enormous walls due to the Titans.",
    ...
    },
    {
      ...
      description:
        "In a world where most people have superpowers called Quirks, Izuku Midoriya dreams of becoming a hero.",
    ...
    },
    {
      title: "Demon Slayer",
      description:
        "Tanjiro Kamado's peaceful life is shattered when a demon slaughters his family.",
    ...
    },
    {
      title: "Chainsaw Man",
      description:
        "Denji is a young man trapped in poverty, working off his deceased father's debt to the yakuza.",
    ...
    },
    {
      ...
      description:
        "Yuji Itadori, a high school student with exceptional physical abilities, stumbles upon a cursed object.",
    ...
    },
    {
      title: "One Punch Man",
      description:
        "Saitama is a hero who can defeat any opponent with a single punch.",
    ...
    },
    {
      title: "Death Note",
      description:
        "Light Yagami finds a notebook that allows him to kill anyone whose name he writes in it.",
