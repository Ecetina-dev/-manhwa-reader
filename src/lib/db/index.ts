...
export async function createManga(
  manga: Omit<
    Manga,
    "id" | "createdAt" | "updatedAt" | "views" | "rating" | "ratingCount"
  >,
): Promise<Manga> {
...
export async function getAllManga(options?: {
  ...
  mangaIds.sort(
    (a, b) =>
      new Date(db.manga[b].updatedAt).getTime() -
      new Date(db.manga[a].updatedAt).getTime(),
  );
...
export async function updateManga(
  ...
  if (updates.status && updates.status !== oldStatus) {
    db.indexes.mangaByStatus[oldStatus] = db.indexes.mangaByStatus[
      oldStatus
    ].filter((i) => i !== id);
...
export async function deleteManga(id: string): Promise<boolean> {
  ...
  db.indexes.mangaByStatus[status] = db.indexes.mangaByStatus[status].filter(
    (i) => i !== id,
  );
...
export async function deleteChapter(id: string): Promise<boolean> {
  ...
  if (db.indexes.chaptersByManga[mangaId]) {
    db.indexes.chaptersByManga[mangaId] = db.indexes.chaptersByManga[
      mangaId
    ].filter((i) => i !== id);
  }
...
export async function seedDatabase(): Promise<void> {
  ...
  > = [
    ...
    },
    {
      title: "One Piece",
      description:
        "Monkey D. Luffy sets off on an adventure with his pirate crew in hopes of finding the greatest treasure ever, known as the One Piece. The story follows him as he makes friends and enemies along the way, battling powerful enemies and uncovering the secrets of the world.",
    ...
    },
    {
      title: "Naruto",
      description:
        "Naruto Uzumaki, a young ninja with a demon fox sealed inside him, dreams of becoming the Hokage, the leader of his village. Through hard work and determination, he grows stronger while making friends and facing powerful enemies.",
    ...
    },
    {
      ...
      description:
        "In a world where humanity lives within cities surrounded by enormous walls due to the Titans, giant humanoid creatures who devour humans seemingly without reason, a young boy named Eren Yeager vows to exterminate all Titans after a tragic event destroys his city and claims the life of his mother.",
    ...
    },
    {
      ...
      description:
        "In a world where most people have superpowers called Quirks, Izuku Midoriya dreams of becoming a hero despite being born without any powers. His life changes when he meets the greatest hero, All Might, who sees potential in him.",
    ...
    },
    {
      title: "Demon Slayer",
      description:
        "Tanjiro Kamado's peaceful life is shattered when a demon slaughters his family and turns his sister Nezuko into a demon. He joins the Demon Slayer Corps to find a way to turn his sister back into a human and defeat the demon who destroyed his family.",
    ...
    },
    {
      title: "Chainsaw Man",
      description:
        "Denji is a young man trapped in poverty, working off his deceased father's debt to the yakuza by working as a Devil Hunter with his pet devil Pochita. After being betrayed and killed, he merges with Pochita to become Chainsaw Man.",
    ...
    },
    {
      ...
      description:
        "Yuji Itadori, a high school student with exceptional physical abilities, stumbles upon a cursed object and becomes the host of a powerful curse named Sukuna. He joins Tokyo Prefectural Jujutsu High School to learn how to fight curses.",
    ...
    },
    {
      title: "One Punch Man",
      description:
        "Saitama is a hero who can defeat any opponent with a single punch. But his incredible strength has become a burden, as he struggles to find an worthy opponent who can give him a challenge.",
    ...
    },
    {
      title: "Death Note",
      description:
        "Light Yagami finds a notebook that allows him to kill anyone whose name he writes in it. He decides to use it to create a perfect world, but is opposed by the mysterious detective L.",
    ...
    },
    {
      title: "Bleach",
      description:
        "Ichigo Kurosaki gains the powers of a Soul Reaper after accidentally absorbing the powers of the Soul Reaper Rukia. He must protect the living world from evil spirits while uncovering the mysteries of his powers.",
